...
> **Implementation note:** Tier 2 (heartbeat probe) was removed during implementation. Tests 8c/8d confirm this is deliberate — heartbeat files do not bypass the stale CT check.
